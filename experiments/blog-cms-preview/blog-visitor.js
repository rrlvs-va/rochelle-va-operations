(function () {
  ...
  function injectWelcomeStyles() {
    ...
    style.textContent = `
      ...
      .tre-welcome-eyebrow{text-transform:uppercase;letter-spacing:.18em;font-size:.72rem;font-weight:800;color:#cb8f96;margin:0 36px 12px}
      .tre-welcome-title{font:500 clamp(3rem,7vw,4.7rem)/.96 Georgia,"Times New Roman",serif;margin:0 auto 24px;color:#f7f1ea;letter-spacing:-.045em}
      .tre-welcome-title span{color:#d1ab63}
      ...
      @media(max-width:620px){.tre-welcome{padding:16px}.tre-welcome-panel{width:100%;max-height:84vh;padding:36px 22px 28px}.tre-welcome-panel:before{left:32px;right:32px}.tre-welcome-title{font-size:clamp(2.55rem,12vw,3.5rem);margin-bottom:20px}.tre-welcome-copy{font-size:.94rem}.tre-welcome-actions{margin-top:22px}}
